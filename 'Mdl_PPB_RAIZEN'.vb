...
Sub GerarPPBRAIZEN()
    ...
    Dim Db As Database, Percentual As Double, unidade As Double, Etapa As String
    ...
    Dim ValorBanco As Double, ValorPPb As Double, TaxaMinina As Double
        ...
        Call AtualizarStatus("1/3", 1, 0)
            ...
            Call AbrirBDPPB
                ...
                & " FROM TblArqoped WHERE (((TblArqoped.Agencia_Ancora)=3075) AND ((TblArqoped.Convenio_Ancora)='008500000042') AND ((TblArqoped.Data_op)>=#" & DataInic & "# And (TblArqoped.Data_op)<=#" & DataFin & "#));")
    
                'Inserir Custo na Tabela Final
                BDPPB.Execute ("INSERT INTO Tbl_PPB_FINAL ( Agencia_Ancora, Convenio_Ancora, Data_Op, Nome_Fornecedor, CNPJ_Fornecedor, COD_OPERACAO, Numero_Nota, Data_Venc, Valor_Nota, Taxa, Prazo, Valor_Juros, Custo, Valor_Banco, PPB_Bruto, CHAVE ) SELECT Tbl_PPB.Agencia_Ancora, Tbl_PPB.Convenio_Ancora, Tbl_PPB.Data_Op, Tbl_PPB.Nome_Fornecedor, Tbl_PPB.CNPJ_Fornecedor, Tbl_PPB.COD_OPERACAO, Tbl_PPB.Numero_Nota, Tbl_PPB.Data_Venc, Tbl_PPB.Valor_Nota, Tbl_PPB.Taxa, Tbl_PPB.Prazo, Tbl_PPB.Valor_Juros, TBL_CUSTO2.CUSTO, Tbl_PPB.Valor_Banco, Tbl_PPB.PPB_Bruto, Tbl_PPB.CHAVE" _
                & " FROM Tbl_PPB INNER JOIN TBL_CUSTO2 ON (Tbl_PPB.COD_OPERACAO = TBL_CUSTO2.Codoperação) AND (Tbl_PPB.Data_Op = TBL_CUSTO2.Dtoperação) WHERE (((Tbl_PPB.Agencia_Ancora)=3075) AND ((Tbl_PPB.Convenio_Ancora)='008500000042') AND ((Tbl_PPB.Data_Op)>=#" & DataInic & "# And (Tbl_PPB.Data_Op)<=#" & DataFin & "#));")
    
                'Calcular PPB
                Set TbDados = BDPPB.OpenRecordset("SELECT Tbl_PPB_FINAL.Agencia_Ancora, Tbl_PPB_FINAL.CHAVE, Tbl_PPB_FINAL.Convenio_Ancora, Tbl_PPB_FINAL.Data_Op, Tbl_PPB_FINAL.Prazo, Tbl_PPB_FINAL.Valor_Nota, Tbl_PPB_FINAL.Valor_Juros, Tbl_PPB_FINAL.Taxa, Tbl_PPB_FINAL.Custo, Tbl_PPB_FINAL.Valor_Banco, Tbl_PPB_FINAL.PPB_Bruto FROM Tbl_PPB_FINAL WHERE (((Tbl_PPB_FINAL.Agencia_Ancora)='3075') AND ((Tbl_PPB_FINAL.Convenio_Ancora)='008500000042') AND ((Tbl_PPB_FINAL.Data_Op)>=#" & DataInic & "# And (Tbl_PPB_FINAL.Data_Op)<=#" & DataFin & "#));", dbOpenDynaset)
...
Sub DiferimentoTblRAIZEN()
    ...
    Set TbDados = BDPPB.OpenRecordset("SELECT Tbl_PPB_FINAL.Data_Op, Tbl_PPB_FINAL.CHAVE, Tbl_PPB_FINAL.Nome_Fornecedor, Tbl_PPB_FINAL.CNPJ_Fornecedor, Tbl_PPB_FINAL.Numero_Nota, Tbl_PPB_FINAL.Data_Venc, Tbl_PPB_FINAL.Valor_Nota, Tbl_PPB_FINAL.Taxa, Tbl_PPB_FINAL.Prazo, Tbl_PPB_FINAL.Valor_Juros, Tbl_PPB_FINAL.Custo, Tbl_PPB_FINAL.Valor_Banco, Tbl_PPB_FINAL.PPB_Bruto FROM Tbl_PPB_FINAL WHERE (((Tbl_PPB_FINAL.Data_Op)>=#" & DataInic & "# And (Tbl_PPB_FINAL.Data_Op)<=#" & DataFin & "#) AND ((Tbl_PPB_FINAL.Agencia_Ancora)='3075') AND ((Tbl_PPB_FINAL.Convenio_Ancora)='008500000042')) ORDER BY Tbl_PPB_FINAL.Data_Op, Tbl_PPB_FINAL.Data_Venc;", dbOpenDynaset)
                ...
                DiferimentoDiario = (TbDados!PPB_Bruto / TbDados!Prazo): DataVencimento = TbDados!Data_Venc: DataOperação = TbDados!Data_op
                    ...
                    If ValorDif(1) > 0 Then
                        ...
                        TbDiferimento.AddNew
                            TbDiferimento!Agencia_Ancora = "3075"
                            TbDiferimento!Convenio_Ancora = "008500000042"
                            TbDiferimento!Nome_Ancora = "RAIZEN"
...
Sub GerarExcelRAIZEN()
  ...
  Set TbDados = BDPPB.OpenRecordset("SELECT Tbl_PPB_FINAL.Data_Op, Tbl_PPB_FINAL.Nome_Fornecedor, Tbl_PPB_FINAL.CNPJ_Fornecedor, Tbl_PPB_FINAL.Numero_Nota, Tbl_PPB_FINAL.Data_Venc, Tbl_PPB_FINAL.Valor_Nota, Tbl_PPB_FINAL.Taxa, Tbl_PPB_FINAL.Prazo, Tbl_PPB_FINAL.Valor_Juros, Tbl_PPB_FINAL.Custo, Tbl_PPB_FINAL.Valor_Banco, Tbl_PPB_FINAL.PPB_Bruto FROM Tbl_PPB_FINAL WHERE (((Tbl_PPB_FINAL.Data_Venc)>=#" & DataInic & "# And (Tbl_PPB_FINAL.Data_Venc)<=#" & DataFin & "#) AND ((Tbl_PPB_FINAL.Agencia_Ancora)='3075') AND ((Tbl_PPB_FINAL.Convenio_Ancora)='008500000042')) ORDER BY Tbl_PPB_FINAL.Data_Op, Tbl_PPB_FINAL.Data_Venc;", dbOpenDynaset)
               ...
               Set ObjPlan1Excel = ObjExcel.Worksheets("Operações")
                ...
                Set TbDados = BDPPB.OpenRecordset("SELECT Tbl_PPB_FINAL.Data_Op, Tbl_PPB_FINAL.Nome_Fornecedor, Tbl_PPB_FINAL.CNPJ_Fornecedor, Tbl_PPB_FINAL.Numero_Nota, Tbl_PPB_FINAL.Data_Venc, Tbl_PPB_FINAL.Valor_Nota, Tbl_PPB_FINAL.Taxa, Tbl_PPB_FINAL.Prazo, Tbl_PPB_FINAL.Valor_Juros, Tbl_PPB_FINAL.Custo, Tbl_PPB_FINAL.Valor_Banco, Tbl_PPB_FINAL.PPB_Bruto FROM Tbl_PPB_FINAL WHERE (((Tbl_PPB_FINAL.Data_op) >= #" & DataInic & "# And (Tbl_PPB_FINAL.Data_op) <= #" & DataFin & "#) And ((Tbl_PPB_FINAL.Agencia_Ancora) = '3075') And ((Tbl_PPB_FINAL.Convenio_Ancora) = '008500000042')) ORDER BY Tbl_PPB_FINAL.Data_Op;", dbOpenDynaset)
                    ...
                    If TbDados.EOF = False Then
                        ...
                        ObjPlan2Excel.Columns("A:AL").Select
                ...
                'Diferimento das Operações vencendos
                    Set ObjPlan3Excel = ObjExcel.Worksheets("Diferimento")
                        ...
                        linha = 3: Coluna = 7: ObjPlan3Excel.Activate
                               
                    Set TbTituloColuna = BDPPB.OpenRecordset("SELECT Tbl_Diferimento.Data_Dif FROM Tbl_Diferimento INNER JOIN Tbl_PPB_FINAL ON Tbl_Diferimento.CHAVE = Tbl_PPB_FINAL.CHAVE WHERE (((Tbl_Diferimento.Agencia_Ancora) = '3075') And ((Tbl_Diferimento.Convenio_Ancora) = '008500000042') And ((Tbl_PPB_FINAL.Data_Venc) >= #" & DataInic & "# And (Tbl_PPB_FINAL.Data_Venc) <= #" & DataFin & "#)) GROUP BY Tbl_Diferimento.Data_Dif ORDER BY Tbl_Diferimento.Data_Dif;", dbOpenDynaset)
                    ...
                    & " FROM Tbl_Diferimento INNER JOIN Tbl_PPB_FINAL ON Tbl_Diferimento.CHAVE = Tbl_PPB_FINAL.CHAVE WHERE (((Tbl_PPB_FINAL.Data_Venc) >= #" & DataInic & "# And (Tbl_PPB_FINAL.Data_Venc) <= #" & DataFin & "#) And ((Tbl_Diferimento.Agencia_Ancora) = '3075') And ((Tbl_Diferimento.Convenio_Ancora) = '008500000042')) GROUP BY Tbl_PPB_FINAL.Data_Op, Tbl_PPB_FINAL.Prazo, Tbl_PPB_FINAL.Data_Venc, Tbl_PPB_FINAL.PPB_Bruto, ([Tbl_PPB_FINAL]![PPB_Bruto]/[Tbl_PPB_FINAL]![Prazo]), Tbl_PPB_FINAL.Numero_Nota ORDER BY Tbl_PPB_FINAL.Data_Op PIVOT Tbl_Diferimento.Data_Dif;", dbOpenDynaset) '
                        ...
                        If TbRefCruzada.EOF = False Then
                            ...
                            ObjPlan3Excel.Columns(po & ":AL").Delete Shift:=xlToLeft
                            ObjPlan3Excel.Activate
                            ObjPlan3Excel.Columns("A:T").Select
                            ObjPlan3Excel.Columns.AutoFit
                        End If
                            
                            Nome = "PPB RAIZEN - " & MesData & " - " & Right(Date, 4)
