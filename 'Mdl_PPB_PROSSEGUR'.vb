    ...
    Dim Percentual As Double, unidade As Double, Etapa As String
        ...
        Call AtualizarStatus("1/3", 1, 0)
            ...
            Call AbrirBDPPB
                ...
                & " FROM TblArqoped WHERE (((TblArqoped.Agencia_Ancora)=3403) AND ((TblArqoped.Convenio_Ancora)='008500000118') AND ((TblArqoped.Data_op)>=#07/01/2015#));")
    
                'Inserir Custo na Tabela Final
                BDPPB.Execute ("INSERT INTO Tbl_PPB_FINAL ( Agencia_Ancora, Convenio_Ancora, Data_Op, Nome_Fornecedor, CNPJ_Fornecedor, COD_OPERACAO, Numero_Nota, Data_Venc, Valor_Nota, Taxa, Prazo, Valor_Juros, Custo, Valor_Banco, PPB_Bruto, CHAVE ) SELECT Tbl_PPB.Agencia_Ancora, Tbl_PPB.Convenio_Ancora, Tbl_PPB.Data_Op, Tbl_PPB.Nome_Fornecedor, Tbl_PPB.CNPJ_Fornecedor, Tbl_PPB.COD_OPERACAO, Tbl_PPB.Numero_Nota, Tbl_PPB.Data_Venc, Tbl_PPB.Valor_Nota, Tbl_PPB.Taxa, Tbl_PPB.Prazo, Tbl_PPB.Valor_Juros, TBL_CUSTO4.CUSTO, Tbl_PPB.Valor_Banco, Tbl_PPB.PPB_Bruto, Tbl_PPB.CHAVE" _
                & " FROM Tbl_PPB INNER JOIN TBL_CUSTO4 ON (Tbl_PPB.COD_OPERACAO = TBL_CUSTO4.Codoperação) AND (Tbl_PPB.Data_Op = TBL_CUSTO4.Dtoperação) WHERE (((Tbl_PPB.Agencia_Ancora)=3403) AND ((Tbl_PPB.Convenio_Ancora)='008500000118') AND ((Tbl_PPB.Data_Op)>=#" & DataInic & "# And (Tbl_PPB.Data_Op)<=#" & DataFin & "#));")
    
                'Calcular PPB
                Set TbDados = BDPPB.OpenRecordset("SELECT Tbl_PPB_FINAL.Agencia_Ancora, Tbl_PPB_FINAL.CHAVE, Tbl_PPB_FINAL.Convenio_Ancora, Tbl_PPB_FINAL.Data_Op, Tbl_PPB_FINAL.Prazo, Tbl_PPB_FINAL.Valor_Nota, Tbl_PPB_FINAL.Valor_Juros, Tbl_PPB_FINAL.Taxa, Tbl_PPB_FINAL.Custo, Tbl_PPB_FINAL.Valor_Banco, Tbl_PPB_FINAL.PPB_Bruto FROM Tbl_PPB_FINAL WHERE (((Tbl_PPB_FINAL.Agencia_Ancora)='3403') AND ((Tbl_PPB_FINAL.Convenio_Ancora)='008500000118') AND ((Tbl_PPB_FINAL.Data_Op)>=#" & DataInic & "# And (Tbl_PPB_FINAL.Data_Op)<=#" & DataFin & "#));", dbOpenDynaset)
        ...
        Call AtualizarStatus("2/3", 1, 0)
            ...
            Call AbrirBDPPB
                ...
                DataFin = Format(DataFinal, "mm/dd/YYYY")
                    ...
                    DataInicioPlan = DataInicio: DataDaPesquisa = DataInicio: Datames = Right(DataDaPesquisa, 7): MesPesq = Mid(DataDaPesquisa, 4, 2): AnoPesq = Right(DataDaPesquisa, 4): cont = 0: Qntd = 1
                ...
                Do While TbDados.EOF = False
                    ...
                    If ValorDif(1) > 0 Then
                        ...
                        TbDiferimento.AddNew
                            ...
                            TbDiferimento!Convenio_Ancora = "008500000118"
                            TbDiferimento!Nome_Ancora = "Prossegur"
            ...
            Call AbrirBDPPB
              ...
              Set TbDados = BDPPB.OpenRecordset("SELECT Tbl_PPB_FINAL.Data_Op, Tbl_PPB_FINAL.Nome_Fornecedor, Tbl_PPB_FINAL.CNPJ_Fornecedor, Tbl_PPB_FINAL.Numero_Nota, Tbl_PPB_FINAL.Data_Venc, Tbl_PPB_FINAL.Valor_Nota, Tbl_PPB_FINAL.Taxa, Tbl_PPB_FINAL.Prazo, Tbl_PPB_FINAL.Valor_Juros, Tbl_PPB_FINAL.Custo, Tbl_PPB_FINAL.Valor_Banco, Tbl_PPB_FINAL.PPB_Bruto FROM Tbl_PPB_FINAL WHERE (((Tbl_PPB_FINAL.Data_Venc)>=#" & DataInic & "# And (Tbl_PPB_FINAL.Data_Venc)<=#" & DataFin & "#) AND ((Tbl_PPB_FINAL.Agencia_Ancora)='3403') AND ((Tbl_PPB_FINAL.Convenio_Ancora)='008500000118')) ORDER BY Tbl_PPB_FINAL.Data_Op, Tbl_PPB_FINAL.Data_Venc;", dbOpenDynaset)
                ...
                Qntd = 1: DataDaPesquisa = DataInicio: Datames = Right(DataDaPesquisa, 7): MesPesq = Mid(DataDaPesquisa, 4, 2): AnoPesq = Right(DataDaPesquisa, 4)
                    ...
                    Set ObjPlan2Excel = ObjExcel.Worksheets("Alocação PPB"): ObjPlan2Excel.Activate
                    ...
                    Set TbDados = BDPPB.OpenRecordset("SELECT Tbl_PPB_FINAL.Data_Op, Tbl_PPB_FINAL.Nome_Fornecedor, Tbl_PPB_FINAL.CNPJ_Fornecedor, Tbl_PPB_FINAL.Numero_Nota, Tbl_PPB_FINAL.Data_Venc, Tbl_PPB_FINAL.Valor_Nota, Tbl_PPB_FINAL.Taxa, Tbl_PPB_FINAL.Prazo, Tbl_PPB_FINAL.Valor_Juros, Tbl_PPB_FINAL.Custo, Tbl_PPB_FINAL.Valor_Banco, Tbl_PPB_FINAL.PPB_Bruto FROM Tbl_PPB_FINAL WHERE (((Tbl_PPB_FINAL.Data_op) >= #" & DataInic & "# And (Tbl_PPB_FINAL.Data_op) <= #" & DataFin & "#) And ((Tbl_PPB_FINAL.Agencia_Ancora) = '3403') And ((Tbl_PPB_FINAL.Convenio_Ancora) = '008500000118')) ORDER BY Tbl_PPB_FINAL.Data_Op;", dbOpenDynaset)
                    ...
                    Loop
                        ...
                        Set TbTituloColuna = BDPPB.OpenRecordset("SELECT Tbl_Diferimento.Data_Dif FROM Tbl_Diferimento INNER JOIN Tbl_PPB_FINAL ON Tbl_Diferimento.CHAVE = Tbl_PPB_FINAL.CHAVE WHERE (((Tbl_Diferimento.Agencia_Ancora) = '3403') And ((Tbl_Diferimento.Convenio_Ancora) = '008500000118') And ((Tbl_PPB_FINAL.Data_Venc) >= #" & DataInic & "# And (Tbl_PPB_FINAL.Data_Venc) <= #" & DataFin & "#)) GROUP BY Tbl_Diferimento.Data_Dif ORDER BY Tbl_Diferimento.Data_Dif;", dbOpenDynaset)
