...
''On Error GoTo Listagem
    ...
    Dim TbDados As Recordset, TbAutorizados As Recordset
    ...
    If IsNull(Me.CbConvenio) Or Me.CbConvenio = "" Then: GoTo Fim
        ...
        Set Db = OpenDatabase("\\Saont46\apps2\Confirming\PROJETORELATORIOS\BD\Relatorios Confirming.mdb")
            ...
            Set Db1 = OpenDatabase("\\saont46\apps2\Confirming\PROJETORELATORIOS\BD\BD_WAIVER_CORPORATE.mdb")

                Set TbAutorizados = Db1.OpenRecordset("SELECT Tbl_Ancoras_Autorizados.Agencia_Ancora, Tbl_Ancoras_Autorizados.Convenio_Ancora, Tbl_Ancoras_Autorizados.Nome_Ancora, Tbl_Ancoras_Autorizados.CNPJ_Ancora, Tbl_Ancoras_Autorizados.Grupo, Tbl_Ancoras_Autorizados.Dt_Cadastro, Tbl_Ancoras_Autorizados.Situacao, Tbl_Ancoras_Autorizados.Usuario, Tbl_Ancoras_Autorizados.Data_UltimoMan" _
                & " FROM Tbl_Ancoras_Autorizados GROUP BY Tbl_Ancoras_Autorizados.Agencia_Ancora, Tbl_Ancoras_Autorizados.Convenio_Ancora, Tbl_Ancoras_Autorizados.Nome_Ancora, Tbl_Ancoras_Autorizados.CNPJ_Ancora, Tbl_Ancoras_Autorizados.Grupo, Tbl_Ancoras_Autorizados.Dt_Cadastro, Tbl_Ancoras_Autorizados.Situacao, Tbl_Ancoras_Autorizados.Usuario, Tbl_Ancoras_Autorizados.Data_UltimoMan HAVING (((Tbl_Ancoras_Autorizados.Agencia_Ancora)=" & Agencia & ") AND ((Tbl_Ancoras_Autorizados.Convenio_Ancora)='" & Convenio & "'));", dbOpenDynaset)




                    If TbAutorizados.EOF = False Then
                    
                        Me.TxDtLiberacao = TbAutorizados!Dt_Cadastro
                        Me.CbSituacao = TbAutorizados!Situacao
                        Me.TxUsuarioMan = TbAutorizados!Usuario
                        Me.TxDataMan = TbAutorizados!Data_UltimoMan
...
Me.TxAgencia = Empty
Me.TxCNPJ = Empty
Me.TxDtLiberacao = Empty
Me.TxDtBloqueio = Empty
Me.TxUsuarioMan = Empty
Me.TxDataMan = Empty
    ...
    End If
        ...
        ConvenioPesq = Me.CbConvenio.Value
            ...
            Set Db = OpenDatabase("\\saont46\apps2\Confirming\PROJETORELATORIOS\BD\BD_WAIVER_CORPORATE.mdb")
               ...
               Set TbDados = Db.OpenRecordset("SELECT Tbl_Ancoras_Autorizados.Agencia_Ancora, Tbl_Ancoras_Autorizados.Convenio_Ancora, Tbl_Ancoras_Autorizados.Nome_Ancora, Tbl_Ancoras_Autorizados.CNPJ_Ancora, Tbl_Ancoras_Autorizados.Dt_Cadastro, Tbl_Ancoras_Autorizados.Dt_Bloqueio, Tbl_Ancoras_Autorizados.Situacao, Tbl_Ancoras_Autorizados.Usuario, Tbl_Ancoras_Autorizados.Data_UltimoMan FROM Tbl_Ancoras_Autorizados WHERE (((Tbl_Ancoras_Autorizados.Agencia_Ancora)=" & Agencia & ") AND ((Tbl_Ancoras_Autorizados.Convenio_Ancora)='" & ConvenioPesq & "'));", dbOpenDynaset)

                    If TbDados.EOF = True Then

                        TbDados.AddNew
                        
                            TbDados!Agencia_Ancora = Me.TxAgencia
                            TbDados!Convenio_Ancora = Me.CbConvenio
                            TbDados!Nome_Ancora = Me.TxNomeAnc
                            TbDados!Cnpj_Ancora = Me.TxCNPJ
                            TbDados!Dt_Cadastro = Format(Me.TxDtLiberacao, "dd/mm/yyyy")
                            If Not IsNull(Me.TxDtBloqueio) Then: TbDados!Dt_Bloqueio = Format(Me.TxDtBloqueio, "dd/mm/yyyy")
                            TbDados!Situacao = Me.CbSituacao
                            TbDados!Usuario = Me.TxUsuario
                            TbDados!Data_UltimoMan = Format(Date, "dd/mm/yyyy")
    
                        TbDados.Update

                            MsgBox "Cliente Cadastrado Com Sucesso!", vbInformation, "Waiver Corporate"
                    ...
                    Else
                        ...
                        TbDados.Update
                            ...
                            MsgBox "Alteração Efetuada Com Sucesso!", vbInformation, "Waiver Corporate"
