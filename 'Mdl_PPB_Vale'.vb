    ...
    Dim Percentual As Double, unidade As Double, Etapa As String
        ...
        Call AtualizarStatus("1/3", 1, 0)
            ...
            Call AbrirBDPPB
                ...
                & " FROM TblArqoped WHERE (((TblArqoped.Agencia_Ancora)=3403) AND ((TblArqoped.Convenio_Ancora)='008500000053') AND ((TblArqoped.Data_op)>=#11/29/2013#));")
    
                'Inserir Custo na Tabela Final
                BDPPB.Execute ("INSERT INTO Tbl_PPB_FINAL ( Agencia_Ancora, Convenio_Ancora, Data_Op, Nome_Fornecedor, CNPJ_Fornecedor, COD_OPERACAO, Numero_Nota, Data_Venc, Valor_Nota, Taxa, Prazo, Valor_Juros, Custo, Valor_Banco, PPB_Bruto, CHAVE ) SELECT Tbl_PPB.Agencia_Ancora, Tbl_PPB.Convenio_Ancora, Tbl_PPB.Data_Op, Tbl_PPB.Nome_Fornecedor, Tbl_PPB.CNPJ_Fornecedor, Tbl_PPB.COD_OPERACAO, Tbl_PPB.Numero_Nota, Tbl_PPB.Data_Venc, Tbl_PPB.Valor_Nota, Tbl_PPB.Taxa, Tbl_PPB.Prazo, Tbl_PPB.Valor_Juros, TBL_CUSTO1.CUSTO, Tbl_PPB.Valor_Banco, Tbl_PPB.PPB_Bruto, Tbl_PPB.CHAVE" _
                & " FROM Tbl_PPB INNER JOIN TBL_CUSTO1 ON (Tbl_PPB.COD_OPERACAO = TBL_CUSTO1.Codoperação) AND (Tbl_PPB.Data_Op = TBL_CUSTO1.Dtoperação) WHERE (((Tbl_PPB.Agencia_Ancora)=3403) AND ((Tbl_PPB.Convenio_Ancora)='008500000053') AND ((Tbl_PPB.Data_Op)>=#" & DataInic & "# And (Tbl_PPB.Data_Op)<=#" & DataFin & "#));")
    
                'Calcular PPB
                Set TbDados = BDPPB.OpenRecordset("SELECT Tbl_PPB_FINAL.Agencia_Ancora, Tbl_PPB_FINAL.CHAVE, Tbl_PPB_FINAL.Convenio_Ancora, Tbl_PPB_FINAL.Data_Op, Tbl_PPB_FINAL.Prazo, Tbl_PPB_FINAL.Valor_Nota, Tbl_PPB_FINAL.Valor_Juros, Tbl_PPB_FINAL.Taxa, Tbl_PPB_FINAL.Custo, Tbl_PPB_FINAL.Valor_Banco, Tbl_PPB_FINAL.PPB_Bruto FROM Tbl_PPB_FINAL WHERE (((Tbl_PPB_FINAL.Agencia_Ancora)='3403') AND ((Tbl_PPB_FINAL.Convenio_Ancora)='008500000053') AND ((Tbl_PPB_FINAL.Data_Op)>=#" & DataInic & "# And (Tbl_PPB_FINAL.Data_Op)<=#" & DataFin & "#));", dbOpenDynaset)
                ...
                Do While TbDados.EOF = False
                    ...
                    If ValorDif(1) > 0 Then
                        ...
                        TbDiferimento.AddNew
                            ...
                            TbDiferimento!Convenio_Ancora = "008500000053"
                            TbDiferimento!Nome_Ancora = "VALE"
            ...
            Call AbrirBDPPB
              ...
              Set TbDados = BDPPB.OpenRecordset("SELECT Tbl_PPB_FINAL.Data_Op, Tbl_PPB_FINAL.Nome_Fornecedor, Tbl_PPB_FINAL.CNPJ_Fornecedor, Tbl_PPB_FINAL.Numero_Nota, Tbl_PPB_FINAL.Data_Venc, Tbl_PPB_FINAL.Valor_Nota, Tbl_PPB_FINAL.Taxa, Tbl_PPB_FINAL.Prazo, Tbl_PPB_FINAL.Valor_Juros, Tbl_PPB_FINAL.Custo, Tbl_PPB_FINAL.Valor_Banco, Tbl_PPB_FINAL.PPB_Bruto FROM Tbl_PPB_FINAL WHERE (((Tbl_PPB_FINAL.Data_Venc)>=#" & DataInic & "# And (Tbl_PPB_FINAL.Data_Venc)<=#" & DataFin & "#) AND ((Tbl_PPB_FINAL.Agencia_Ancora)='3403') AND ((Tbl_PPB_FINAL.Convenio_Ancora)='008500000053')) ORDER BY Tbl_PPB_FINAL.Data_Op, Tbl_PPB_FINAL.Data_Venc;", dbOpenDynaset)
                ...
                Qntd = 1: DataDaPesquisa = DataInicio: Datames = Right(DataDaPesquisa, 7): MesPesq = Mid(DataDaPesquisa, 4, 2): AnoPesq = Right(DataDaPesquisa, 4)
                    ...
                    Set TbDados = BDPPB.OpenRecordset("SELECT Tbl_PPB_FINAL.Data_Op, Tbl_PPB_FINAL.Nome_Fornecedor, Tbl_PPB_FINAL.CNPJ_Fornecedor, Tbl_PPB_FINAL.Numero_Nota, Tbl_PPB_FINAL.Data_Venc, Tbl_PPB_FINAL.Valor_Nota, Tbl_PPB_FINAL.Taxa, Tbl_PPB_FINAL.Prazo, Tbl_PPB_FINAL.Valor_Juros, Tbl_PPB_FINAL.Custo, Tbl_PPB_FINAL.Valor_Banco, Tbl_PPB_FINAL.PPB_Bruto FROM Tbl_PPB_FINAL WHERE (((Tbl_PPB_FINAL.Data_op) >= #" & DataInic & "# And (Tbl_PPB_FINAL.Data_op) <= #" & DataFin & "#) And ((Tbl_PPB_FINAL.Agencia_Ancora) = '3403') And ((Tbl_PPB_FINAL.Convenio_Ancora) = '008500000053')) ORDER BY Tbl_PPB_FINAL.Data_Op;", dbOpenDynaset)
                        ...
                        If TbDados.EOF = False Then
                            ...
                            Contador = 0: unidade = Round((8200 / Quantidade), 2): Etapa = "3/3"
                                ...
                                Do While TbDados.EOF = False
                                    ...
                                    Debug.Print "linha " & LinhaDiferimento
                        ...
                        Set TbTituloColuna = BDPPB.OpenRecordset("SELECT Tbl_Diferimento.Data_Dif FROM Tbl_Diferimento INNER JOIN Tbl_PPB_FINAL ON Tbl_Diferimento.CHAVE = Tbl_PPB_FINAL.CHAVE WHERE (((Tbl_Diferimento.Agencia_Ancora) = '3403') And ((Tbl_Diferimento.Convenio_Ancora) = '008500000053') And ((Tbl_PPB_FINAL.Data_Venc) >= #" & DataInic & "# And (Tbl_PPB_FINAL.Data_Venc) <= #" & DataFin & "#)) GROUP BY Tbl_Diferimento.Data_Dif ORDER BY Tbl_Diferimento.Data_Dif;", dbOpenDynaset)
                        ...
                        & " FROM Tbl_Diferimento INNER JOIN Tbl_PPB_FINAL ON Tbl_Diferimento.CHAVE = Tbl_PPB_FINAL.CHAVE WHERE (((Tbl_PPB_FINAL.Data_Venc) >= #" & DataInic & "# And (Tbl_PPB_FINAL.Data_Venc) <= #" & DataFin & "#) And ((Tbl_Diferimento.Agencia_Ancora) = '3403') And ((Tbl_Diferimento.Convenio_Ancora) = '008500000053')) GROUP BY Tbl_PPB_FINAL.Data_Op, Tbl_PPB_FINAL.Prazo, Tbl_PPB_FINAL.Data_Venc, Tbl_PPB_FINAL.PPB_Bruto, ([Tbl_PPB_FINAL]![PPB_Bruto]/[Tbl_PPB_FINAL]![Prazo]), Tbl_PPB_FINAL.Numero_Nota ORDER BY Tbl_PPB_FINAL.Data_Op PIVOT Tbl_Diferimento.Data_Dif;", dbOpenDynaset) '
                            ...
                            End If
                                ...
                                Nome = "PPB VALE - " & MesData & " - " & Right(Date, 4)
