...
Set TbDados1 = Db1.OpenRecordset("SELECT TblRelatoriosEnviados.Agencia_Ancora, TblRelatoriosEnviados.Convenio_Ancora, TblRelatoriosEnviados.Cnpj_Ancora, TblRelatoriosEnviados.Nome_Ancora, TblRelatoriosEnviados.Relatorio_Enviado, TblRelatoriosEnviados.Periodicidade_Relatorio, TblRelatoriosEnviados.Data_Envio, TblRelatoriosEnviados.Hora_Envio, TblRelatoriosEnviados.Usuario FROM TblRelatoriosEnviados WHERE (((TblRelatoriosEnviados.Data_Envio)=#" & DataPesq & "#));", dbOpenDynaset)

            
            Me.ListEnviados.RowSource = ""      ' Limpar o ListBox
            Me.ListEnviados.RowSourceType = "Value List"
            Me.ListEnviados.ColumnCount = 7
            Me.ListEnviados.ColumnHeads = True
            Me.ListEnviados.AddItem ("Agencia") & ";" & ("Convênio") & ";" & ("Nome") & ";" & ("Relatorio") & ";" & ("Data Envio") & ";" & ("Hora Envio") & ";" & ("Usuario")
       
    Do While TbDados1.EOF = False
    
       Me.ListEnviados.AddItem (TbDados1!Agencia_Ancora) & ";" & (TbDados1!Convenio_Ancora) & ";" & (TbDados1!Nome_Ancora) & ";" & (TbDados1!Relatorio_Enviado) & ";" & (TbDados1!Data_Envio) & ";" & (TbDados1!Hora_Envio) & ";" & (TbDados1!Usuario)
   '    DoEvents
