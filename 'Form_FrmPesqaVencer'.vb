...
Set TbDados = Db.OpenRecordset("SELECT TblArqoped.Nome_Ancora, TblArqoped.Banco_Ancora, TblArqoped.Agencia_Ancora, TblArqoped.Convenio_Ancora, TblArqoped.Cnpj_Ancora, TblArqoped.Nome_Fornecedor, TblArqoped.Cnpj_Fornecedor, TblArqoped.Cod_Oper, TblArqoped.Modalidade_Oper, TblArqoped.Tipo_Liq, TblArqoped.Banco_Remet, TblArqoped.Agencia_Remet, TblArqoped.Conta_Remet, TblArqoped.Tipo_Pag, TblArqoped.Banco_Fav, TblArqoped.Agencia_Fav, TblArqoped.Conta_fav, TblArqoped.Data_op, TblArqoped.Data_Final, TblArqoped.Prazo_Medio, TblArqoped.Prazo_NF, TblArqoped.Juros, TblArqoped.Custo, TblArqoped.Spread, TblArqoped.Spread_Anual, TblArqoped.Valor_op, TblArqoped.Valor_TCO, TblArqoped.Valot_TTR, TblArqoped.Compromisso, TblArqoped.Data_Venc, TblArqoped.Valor_Nom, TblArqoped.Valor_Abat, TblArqoped.Valor_Acres," _
& " TblArqoped.Valor_Pagmto , TblArqoped.Valor_Juros, TblArqoped.Valor_IOF, TblArqoped.Valor_Liquido, TblArqoped.Valor_Custo, TblArqoped.Spread_Banco, TblArqoped.Receita_Banco, TblArqoped.Tp_Apur_prem, TblArqoped.Tp_Rem_prem, TblArqoped.Tp_Pgto_prem, TblArqoped.Dt_pfto_Prem, TblArqoped.Cod_Bco_Prem, TblArqoped.Cod_Age_Prem, TblArqoped.Cod_Conta_prem, TblArqoped.Rate_Spread, TblArqoped.Spread_Clte, TblArqoped.Receita_Clte FROM TblArqoped" _
& " GROUP BY TblArqoped.Nome_Ancora, TblArqoped.Banco_Ancora, TblArqoped.Agencia_Ancora, TblArqoped.Convenio_Ancora, TblArqoped.Cnpj_Ancora, TblArqoped.Nome_Fornecedor, TblArqoped.Cnpj_Fornecedor, TblArqoped.Cod_Oper, TblArqoped.Modalidade_Oper, TblArqoped.Tipo_Liq, TblArqoped.Banco_Remet, TblArqoped.Agencia_Remet, TblArqoped.Conta_Remet, TblArqoped.Tipo_Pag, TblArqoped.Banco_Fav, TblArqoped.Agencia_Fav, TblArqoped.Conta_fav, TblArqoped.Data_op, TblArqoped.Data_Final, TblArqoped.Prazo_Medio, TblArqoped.Prazo_NF, TblArqoped.Juros, TblArqoped.Custo, TblArqoped.Spread, TblArqoped.Spread_Anual, TblArqoped.Valor_op, TblArqoped.Valor_TCO, TblArqoped.Valot_TTR, TblArqoped.Compromisso," _
& " TblArqoped.Data_Venc , TblArqoped.Valor_Nom, TblArqoped.Valor_Abat, TblArqoped.Valor_Acres, TblArqoped.Valor_Pagmto, TblArqoped.Valor_Juros, TblArqoped.Valor_IOF, TblArqoped.Valor_Liquido, TblArqoped.Valor_Custo, TblArqoped.Spread_Banco, TblArqoped.Receita_Banco, TblArqoped.Tp_Apur_prem, TblArqoped.Tp_Rem_prem, TblArqoped.Tp_Pgto_prem, TblArqoped.Dt_pfto_Prem, TblArqoped.Cod_Bco_Prem, TblArqoped.Cod_Age_Prem, TblArqoped.Cod_Conta_prem, TblArqoped.Rate_Spread, TblArqoped.Spread_Clte, TblArqoped.Receita_Clte HAVING (((TblArqoped.Agencia_Ancora) = " & AGENCIAPESQ & ") And ((TblArqoped.Convenio_Ancora) = '" & ConvenioPesq & "') And ((TblArqoped.Data_Venc) >= #" & DataInicio & "# And (TblArqoped.Data_Venc) <= #" & DATAFIM & "#)) ORDER BY TblArqoped.Data_op;", dbOpenDynaset)

If TbDados.EOF = True Then
Me.LbValida.Caption = "O Cliente não possui Operação com vencimento na data selecionada!"
Me.LbValida.FontBold = True
...
Caminho = "\\saont46\apps2\Confirming\PROJETORELATORIOS\MASCARAS\XLSX\"
   ...
   ObjExcel.Workbooks.Open FileName:=Caminho & "PesqNotasAvencer.xlsx", ReadOnly:=True
  ...
  ObjPlan1Excel.Range("C2").Select
   ...
   Nome = "Relatorio Notas a Vencer - " & NomeCliente & " - " & Format(Data, "ddmmyy")
   ...
   ObjExcel.Quit
    ...
    CAMINHOABRIR = "excel.exe C:\Temp\" & Nome & ".xlsx"
       Call Shell(CAMINHOABRIR, 1)
...
Private Sub Comando54_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
